...
Usage: run_grid_search_linear_model_polynomial_data.py  [options] --cfg=<path_to_config> --o=<output_dir>
...
from run_linear_model_polynomial_data import make_model, fit, evaluate
