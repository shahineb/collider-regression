"""
Description : Runs hyperparameter search for kernel ridge regression regression experiment with polynomial data generating process

Usage: run_grid_search_kernel_model_polynomial_data.py  [options] --cfg=<path_to_config> --o=<output_dir>
